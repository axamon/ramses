...
func kalmansample(speeds []float64, stdev float64) {
	...
	for i = 0; i < n; i++ {
		...
		ma20Upperband = append(ma20Upperband, sma20.Avg()+2*devstdBands)
		ma20Lowerband = append(ma20Lowerband, sma20.Avg()-2*devstdBands)
	...
	err = plotutil.AddLinePoints(p,
		...
		"MA20", generatePoints(xary, ma20),
		"UpBollinger", generatePoints(xary, ma20Upperband),
		"LowBollinger", generatePoints(xary, ma20Lowerband),
	)
	if err != nil {
		log.Println(err)
	}
