...
func elaboraseriePPP(ctx context.Context, x, lista []float64, device, interfaccia, metrica string) {
	...
	for {
		...
		default:
			...
			//elimino il trend
			xdet, ydet := algoritmi.Detrend(x, lista)
			...
			speeds := algoritmi.ScremaValori(yderived, 0.98, 0.02)
