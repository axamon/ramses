...
//ScremaValori elimina i valori oltre il 99 percentile e sotto il primo percentile
func ScremaValori(values []float64, qmax, qmin float64) (speeds []float64) {
	...
	//Devo copiare la slide in entrata su una struttura di appoggio per sortarla
	copy(q, values)
